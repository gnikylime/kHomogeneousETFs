...
Code to accompany the paper <a href="https://arxiv.org/pdf/2505.00160">k-Homogeneous ETFs</a>, Emily J. King.
 ...
 ### Code 
The code is written in Matlab, GAP, and SAGE, with the latter two languages in a Jupyter notebook. Joey Iverson and CoCalc's code assist powered by ChatGPT helped with the GAP and SAGE code.<br>
...
<tt>PaleyDiffSet.ipynb</tt> Code to generate a .mat file of quadratic residues in F_{p^s}, represented as rows in a (p^s-1)/2 x s integer matrix<br>
<tt>Paley_p_s.mat</tt> A selection of .mat files of quadratic residues in F_{p^s}, generated by <tt>PaleyDiffSet.ipynb</tt>
